...
namespace Shinject.Tests.Unit.Infrastructure.Language
{
    ...
    public class ExtensionsForIEnumerableTests
    {
        ...
        public void ToListSlow_AssigmentCompatibility()
        {
            ...
            var actual = Shinject.Infrastructure.Language.ExtensionsForIEnumerable.ToListSlow(enumerable, typeof(IWeapon));
        ...
        public void ToListSlow_Contravariance()
        {
            ...
            var actualException = Assert.Throws<ArgumentException>(() => Shinject.Infrastructure.Language.ExtensionsForIEnumerable.ToListSlow(enumerable, typeof(IWeapon)));
        ...
        public void CastSlow_Covariance()
        {
            ...
            var actual = Shinject.Infrastructure.Language.ExtensionsForIEnumerable.CastSlow(enumerable, typeof(IWeapon));
        ...
        public void CastSlow_Contravariance()
        {
            ...
            var actual = Shinject.Infrastructure.Language.ExtensionsForIEnumerable.CastSlow(enumerable, typeof(IWarrior));
