...
namespace Shinject.Tests.Unit.Selection
{
    using FluentAssertions;
    using Moq;
    using Shinject.Selection;
    ...
    public class SelectorTests
    {
        ...
        public SelectorTests()
        {
            ...
            _selector = new Selector(_injectionHeuristics) { Settings = _settingsMock.Object };
        }
        ...
        public void Constructor_ShouldThrowArgumentNullExceptionWhenInjectionHeuristicsIsNull()
        {
            ...
            var actual = Assert.Throws<ArgumentNullException>(() => new Selector(injectionHeuristics) { Settings = _settingsMock.Object });
